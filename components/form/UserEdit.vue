<template>
     <div>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            <label>File </label> 
            <input type="file" id="file" class="form-control" :class="{'is-invalid': errors.file}"  @change="handleFileUpload( $event )"/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" :class="{'is-invalid': errors.username}" v-model="users.username">
